...
public final class Tiles {
	...
	public static void initTileList() {
		...
		tiles.set(41, new PurpleWoolTile("Purple Wool"));
		tiles.set(42, new BlackWoolTile("Black Wool"));
		tiles.set(43, new PinkWoolTile("Pink Wool"));
		tiles.set(44, new DarkGreenWoolTile("Dark Green Wool"));
		tiles.set(45, new GrayWoolTile("Gray Wool"));
		tiles.set(46, new BrownWoolTile("Brown Wool"));
		tiles.set(47, new MagentaWoolTile("Magenta Wool"));
