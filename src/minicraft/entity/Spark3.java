...
public class Spark3 extends Entity {
	...
	private AirWizardPhase3 owner; // the AirWizard that created this spark
	 ...
	 * @param ya Y velocity.
	 */
	public Spark3(AirWizardPhase3 owner, double xa, double ya) {
		super(0, 0);
	...
	public void tick() {
		...
		for (int i = 0; i < toHit.size(); i++) {
			...
			if (e instanceof Mob && !(e instanceof AirWizardPhase3 )) {
