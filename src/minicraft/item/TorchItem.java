...
public class TorchItem extends TileItem {
	...
	private TorchItem(int count) {
		super("Torch", (new Sprite(5, 3, 0)), count, "", "dirt", "Wood Planks", "Stone Bricks", "Obsidian", "Wool", "Red Wool", "Blue Wool", "Green Wool", "Yellow Wool", "Purple Wool", "Pink Wool", "Dark Green Wool", "Gray Wool", "Brown Wool", "Magenta Wool", "Light Blue Wool", "Cyan Wool", "Orange Wool", "Black Wool", "grass", "sand");
	}
